...
function addActive() {
    var buttonActive = document.querySelectorAll('.menu__items_btn');
    ...
    function switch0ff() {
        for (var _i = 0; _i < buttonActive.length; _i++) {
            buttonActive[_i].classList.remove('menu__items_btn_active');
        }
    }
}
addActive();
