...
function aсcordion() {
    var ACTIVE_CLASSNAME = 'leftblock-menu__container_open';
    var container = document.querySelectorAll('.leftblock-menu__container');
    ...
    function switchOff() {
        for (var _i = 0; _i < container.length; _i++) {
            container[_i].classList.remove(ACTIVE_CLASSNAME);
        }
    }
